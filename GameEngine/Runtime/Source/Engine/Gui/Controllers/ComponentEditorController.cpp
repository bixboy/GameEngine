...
namespace BixEngine::Gui
{
    ...
    std::shared_ptr<ComponentEditorController::SharedState> ComponentEditorController::CreateSharedState(std::filesystem::path assetPath, String stableIdRoot, std::function<void()> onCloseRequest)
    {
