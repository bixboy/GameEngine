...
namespace BixEngine::resources
{
    ...
    void SpriteAnimator::Update(float deltaTime) noexcept
    {
        ...
        currentFrameIndex_ = AdvanceFrame(accumulatedTime_, deltaTime, currentAnimation_->frameRate, currentFrameIndex_, currentAnimation_->frameIndices.size(), currentAnimation_->loop);
