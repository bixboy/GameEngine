...
namespace BixEngine::Gui
{
    namespace
    {
        ...
        GuiPanel* TryCreatePanel(const char* name, CreateFunc&& createFunc, GuiManager& gui, const DefaultEngineGuiContext& ctx)
        {
            try
            {
        ...
        {
        public:
            DefaultEngineGuiPanelManager(GuiManager& guiManager, const DefaultEngineGuiContext& context): guiManager_(guiManager), context_(context)
            {
            }
